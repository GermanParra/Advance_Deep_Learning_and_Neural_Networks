...
known_image = face_recognition.load_image_file(r"Exercise Files\Windows Exercise Files\Ch07\test_face.jpg")
...
for image_path in Path("Exercise Files\Windows Exercise Files\Ch07\people").glob("*.png"):
